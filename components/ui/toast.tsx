...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "group-[.success]:border-green-300 group-[.success]:hover:bg-green-600 group-[.success]:text-white",
      "group-[.warning]:border-yellow-300 group-[.warning]:hover:bg-yellow-600 group-[.warning]:text-black",
      "group-[.info]:border-blue-300 group-[.info]:hover:bg-blue-600 group-[.info]:text-white",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "group-[.info]:text-blue-200 group-[.info]:hover:text-white group-[.info]:focus:ring-blue-400 group-[.info]:focus:ring-offset-blue-600",
      className
    )}
    toast-close=""
    {...props}
